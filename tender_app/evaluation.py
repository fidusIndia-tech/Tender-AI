"""Shared rule-based tender evaluation helpers.

These functions are the canonical implementation used by both main.py (the
manual upload/evaluate endpoints) and gem_watcher.evaluator (the GeM pipeline).
Keep them here so there is a single importable source of truth.
"""
import re
